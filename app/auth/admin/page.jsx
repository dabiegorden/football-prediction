...
export default function AdminLoginPage() {
  ...
  const handleAdminLogin = async (e) => {
    ...
    try {
      // Check credentials against the predefined adminLogin object
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-600 to-purple-700 p-4">
      <div className="w-full max-w-md">
                ...
                >
                  {isPasswordVisible ? (
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M3.707 2.293a1 1 0 00-1.414 1.414l14 14a1 1 0 001.414-1.414l-1.473-1.473A10.014 10.014 0 0019.542 10C18.268 5.943 14.478 3 10 3a9.958 9.958 0 00-4.512 1.074l-1.781-1.781zm4.261 4.261l1.514 1.514a2.003 2.003 0 012.45 2.45l1.514 1.514a4 4 0 00-5.478-5.478z"
                        clipRule="evenodd"
                      />
        ...
        <div className="text-center mt-6 text-white">
          <p className="text-sm">
            © {new Date().getFullYear()} Football Predictions Admin.
            <br />
            Secure Access Only
          </p>
        </div>
